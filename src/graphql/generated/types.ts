...
export type BaseFilterInput = {
  and?: InputMaybe<Array<BaseFilterInput>>;
  filtername: Filtername;
  key?: InputMaybe<Scalars['String']['input']>;
  negator?: InputMaybe<Scalars['String']['input']>;
  operator?: InputMaybe<Scalars['String']['input']>;
  or?: InputMaybe<Array<BaseFilterInput>>;
...
export type Member = {
  ...
  overrideTeammate: Scalars['Boolean']['output'];
...
export type MemberNetworkNotificationSettings = {
  ...
  sameAsDefault: Scalars['Boolean']['output'];
};
...
export type Mutation = {
  ...
  /** @deprecated Use "updateSubscriptionSettings" instead */
  ...
  updateSpace: Space;
  /** @deprecated Use "updatePublisherSettings" instead */
...
export type Publisher = {
  ...
  id: Scalars['ID']['output'];
  notifyImplicitSubscriptions: Scalars['Boolean']['output'];
};
...
export type Query = {
  ...
  /** @deprecated Use "subscriptionSettings" instead */
  ...
  /** @deprecated Use "authMemberProps.subscribed" field on "Space" type instead */
  ...
  /** @deprecated Use "authMemberProps.subscribed" field on "Post" type instead */
  ...
  recommendResources: Array<SmartSearchResource>;
  redirect: Redirect;
...
export type QueryRecommendResourcesArgs = {
...
export type RecommendResourcesInput = {
  limit?: InputMaybe<Scalars['Float']['input']>;
  negativeEntityIds?: InputMaybe<Array<Scalars['String']['input']>>;
  positiveEntityIds: Array<Scalars['String']['input']>;
...
export type SmartSearchInput = {
  level?: InputMaybe<AssistantLevel>;
  query: Scalars['String']['input'];
};

export type SmartSearchResource = {
  __typename?: 'SmartSearchResource';
  additional: SmartSearchResourceAdditional;
  entity?: Maybe<SearchObjectEntity>;
  info: SmartSearchResourceInfo;
  source: SmartSearchSource;
  type: Scalars['String']['output'];
  uuid: Scalars['String']['output'];
};

export type SmartSearchResourceAdditional = {
  __typename?: 'SmartSearchResourceAdditional';
  score: Scalars['Float']['output'];
};

export type SmartSearchResourceInfo = {
  __typename?: 'SmartSearchResourceInfo';
  description?: Maybe<Scalars['String']['output']>;
  icon?: Maybe<Media>;
  id: Scalars['String']['output'];
  spaceId?: Maybe<Scalars['String']['output']>;
...
export type SmartSearchResult = {
  __typename?: 'SmartSearchResult';
  answer?: Maybe<Scalars['String']['output']>;
  resources: Array<SmartSearchResource>;
};

export enum SmartSearchSource {
  Post = 'POST'
}
...
export type SpaceDefaultNotificationSettings = {
  __typename?: 'SpaceDefaultNotificationSettings';
  channel: NotificationChannel;
  enabled?: Maybe<Scalars['Boolean']['output']>;
  isDefault: Scalars['Boolean']['output'];
  preference?: Maybe<SpaceNotificationPreference>;
...
export type SubscriptionSmartSearchArgs = {
  input: SmartSearchInput;
};
...
export type UpdateMemberNetworkNotificationSettingsInput = {
  ...
  options?: InputMaybe<UpdateMemberNetworkNotificationSettingsOptionsInput>;
  reaction?: InputMaybe<Scalars['Boolean']['input']>;
  sameAsDefault?: InputMaybe<Scalars['Boolean']['input']>;
};

export type UpdateMemberNetworkNotificationSettingsOptionsInput = {
  /** Required if channel is DESKTOP */
  fcmDeviceToken?: InputMaybe<Scalars['String']['input']>;
};
...
export type UpdateMemberSpaceNotificationSettingsInput = {
  enabled?: InputMaybe<Scalars['Boolean']['input']>;
  memberId?: InputMaybe<Scalars['ID']['input']>;
  preference?: InputMaybe<SpaceNotificationPreference>;
  sameAsDefault?: InputMaybe<Scalars['Boolean']['input']>;
};
...
export type GetPostQuery = { __typename?: 'Query', post: { __typename?: 'Post', id: string, title?: string | null, description?: string | null, textContent?: string | null, reactionsCount: number, fields?: Array<{ __typename?: 'CustomField', key: string, value?: string | null, relationEntities?: { __typename?: 'CustomFieldRelation', medias: Array<{ __typename?: 'Emoji' } | { __typename?: 'File' } | { __typename?: 'Glyph' } | { __typename?: 'Image', urls?: { __typename?: 'MediaUrls', medium: string } | null }> } | null }> | null } };
...
export type GetPostsQuery = { __typename?: 'Query', posts: { __typename?: 'PaginatedPost', totalCount: number, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, endCursor?: string | null }, edges?: Array<{ __typename?: 'PostEdge', node: { __typename?: 'Post', id: string, title?: string | null, description?: string | null, reactionsCount: number, fields?: Array<{ __typename?: 'CustomField', key: string, value?: string | null, relationEntities?: { __typename?: 'CustomFieldRelation', medias: Array<{ __typename?: 'Emoji' } | { __typename?: 'File' } | { __typename?: 'Glyph' } | { __typename?: 'Image', urls?: { __typename?: 'MediaUrls', medium: string } | null }> } | null }> | null } }> | null } };
...
export const GetPostsDocument = gql`
    query GetPosts($after: String, $filterBy: [PostListFilterByInput!], $limit: Int!, $offset: Int, $orderByString: String, $reverse: Boolean, $spaceIds: [ID!]) {
  posts(
    after: $after
    filterBy: $filterBy
    limit: $limit
